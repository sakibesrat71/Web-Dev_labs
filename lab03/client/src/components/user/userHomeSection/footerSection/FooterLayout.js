...
import footerImage from "../../../../assets/img/f1r.png"

export default function FooterLayout() {
  return (
    <div className="max-w-screen-xl p-4 py-12 mx-auto lg:py-16 md:p-8 lg:p-10">
    <div className="grid grid-cols-2 gap-8 md:grid-cols-3 lg:grid-cols-5">
      <div>
        ...
        <ul className="text-gray-500 dark:text-gray-400">
          <li className="mb-4">
            <NavLink to="/library" className="hover:underline">Library</NavLink>
          </li>
          <li className="mb-4">
      ...
      <div>
        ...
        <ul className="text-gray-500 dark:text-gray-400">
          <li className="mb-4">
            <NavLink to="#" className="hover:underline">Discord Server</NavLink>
          </li>
          <li className="mb-4">
      ...
      <div  className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white"> 
        <img src={footerImage}  alt='footerLogo' />
    ...
    <div className="text-center">
      ...
      <span
        ...
        >© 2023-2025 LMS. All Rights Reserved. 
