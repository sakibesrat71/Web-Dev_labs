...
export default function UserErrorLayout() {
  return (
    <main class="grid min-h-full place-items-center bg-white py-24 px-6 sm:py-32 lg:px-8">
  <div class="text-center">
    <img src={errorImage} alt="errorImage" className="object-cover h-50 w-70 "/>
    <br/>
    <p class="text-base font-semibold text-indigo-600 ">404</p>
    <h1 class="mt-4 text-3xl font-bold tracking-tight text-gray-900 sm:text-5xl animate-pulse ">Page not found !</h1>
