...
import BookStoreTableLayout from './dataTableSection/BookStoreTableLayout'
...
export default function BookStoreLayout() {
  return (
    ...
    <RightBarLayout searchInputPlaceholder="Search by Book Name..." />
     <main className="p-6 sm:p-10 space-y-6">
       <HeaderText text="Book Store" />
     <div style={{width:"1000px"}} >
      
     <BookStoreTableLayout />
